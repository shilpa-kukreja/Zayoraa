...
export default function AllProducts() {
  ...
  // Detect if any filter is active (to show appropriate empty message)
  ...
  // Apply filters – now depends on both filters and products
  useEffect(() => {
    let result = [...products];
  ...
  }, [filters, products]); // ← now re‑runs when products arrive
  ...
  const renderProductCard = (product) => {
    ...
    return (
      <div className="bg-white border border-[#7251d6] rounded-md overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 h-full flex flex-col">
              ...
              <button
                ...
                className={`w-full py-2 rounded-md ${
                  outOfStock
                    ...
                    : 'bg-[#5d3fb8] text-white hover:bg-black'
                }`}
              >
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex gap-3">
                    ...
                    <button
                      ...
                      className="px-4 py-2 bg-[#8D6AF8] text-white rounded-lg flex-1"
                    >
                      Apply
                    </button>
                  </div>
          ...
          <div className="w-full lg:w-3/4">
            ...
            hasActiveFilters ? (
              <div className="text-center sm:py-16 py-6 bg-white rounded-xl shadow-sm border border-gray-100">
                ...
                <button
                  onClick={resetFilters}
                  className="px-6 py-2 bg-[#6143bd] text-white rounded-lg hover:bg-black transition"
                >
                  Reset Filters
                </button>
              </div>
              ...
              // Products still loading (products.length === 0)
              <div className="text-center sm:py-16 py-6">
