...
const CategoryPage = () => {
  ...
  const renderProductCard = (product) => {
    ...
    return (
      <div className="bg-white border border-[#6144b8] rounded-md overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 h-full flex flex-col">
              ...
              <button
                ...
                className={`w-full py-2 rounded-md ${
                  outOfStock
                    ...
                    : 'bg-[#6242c2] text-white hover:bg-black'
                }`}
              >
      ...
      <div className="container mx-auto sm:px-4 px-2 sm:py-8 py-5">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="w-full lg:w-3/4">
            ...
            ) : filteredProducts.length === 0 && products.length > 0 && categoryProducts.length === 0 ? (
              <div className="text-center sm:py-16 py-6 bg-white rounded-xl shadow-sm border border-gray-100">
                <h3 className="text-xl font-medium text-gray-700">No products in this category yet</h3>
              </div>
