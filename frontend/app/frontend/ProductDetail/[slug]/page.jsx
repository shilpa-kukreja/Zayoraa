...
const ProductDetailContent = ({ productIDs }) => {
  ...
  return (
    <div>
      ...
      <div
        className={`max-w-7xl border-t border-gray-200 mx-auto px-4 sm:px-6 lg:px-8 py-8 ${isCartOpen ? "blur-sm" : ""}`}
      >
        {/* Breadcrumb */}
        <nav className="flex mb-6" aria-label="Breadcrumb">
          <ol className="inline-flex items-center space-x-1 md:space-x-2">
            ...
            <div className="mb-4">
              ...
              <div className="flex items-center border border-gray-300 rounded-md w-fit overflow-hidden">
                ...
                <motion.button
                  ...
                  onClick={() => handleQuantityChange(1)}
                  className="px-3 py-2 text-gray-600 hover:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                  disabled={quantity >= Math.min(selectedVariant.stock, 30)}
                >
                  +
                </motion.button>
              </div>
            ...
            >
              ...
              <button
                ...
                className={`w-28 h-48 border rounded-md overflow-hidden relative group ${
                  selectedVideo === vid.videourl ? "ring-2 ring-[#7a1113]" : ""
                }`}
              >
                <video
