        ...
        <div className="text-center mb-8">
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-6">
            <button
              ...
              className="px-6 py-3 bg-blue-600 text-white rounded-xl shadow hover:bg-blue-700 transition flex items-center justify-center gap-2 disabled:opacity-70"
            >
              {downloading ? (
                <>
          ...
          <div className="lg:col-span-2 bg-white rounded-2xl shadow-lg overflow-hidden">
            <div className="bg-gray-50 px-6 py-4 border-b flex justify-between items-center">
              ...
              <button
                onClick={downloadInvoice}
                disabled={downloading}
                className="sm:px-4 sm:py-2 px-3 py-1 bg-blue-600 text-white rounded-lg text-sm hover:bg-blue-700 transition flex items-center gap-2 disabled:opacity-70"
              >
                <Download size={16} />
