    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            <div className='text-center sm:mt-6 mt-5'>
                <h1 className="text-2xl md:text-4xl font-bold mb-4">BestSellers</h1>
            </div>
            ...
            <div className="container mx-auto px-4 sm:py-8 py-5">
                <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    <div className="w-full lg:w-3/4">
                        ...
                        ) : filteredProducts.length === 0 && products.length > 0 && bestSellerProducts.length === 0 ? (
                            <div className="text-center sm:py-16 py-6 bg-white rounded-xl shadow-sm border border-gray-100">
                                <h3 className="text-xl font-medium text-gray-700">No best sellers at the moment</h3>
                            </div>
