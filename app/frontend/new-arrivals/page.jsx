...
export default function NewArrivals() {
    ...
    const newArrivalProducts = useMemo(
        () => products.filter((product) => product.section?.includes('newarrival')),
        [products]
    );
    ...
    const renderProductCard = (product) => {
        ...
        return (
            <div className="bg-white border border-[#5d3cbe] rounded-md overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 h-full flex flex-col">
                            ...
                            <button
                                ...
                                className={`w-full py-2 rounded-md ${
                                    outOfStock
                                        ...
                                        : 'bg-[#613eca] text-white hover:bg-black'
                                }`}
                            >
            ...
            <div className="container mx-auto sm:px-4 px-2 sm:py-8 py-5">
                <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    <div className="w-full lg:w-3/4">
                        {/* Sort By - Desktop */}
                        <div className="hidden lg:flex justify-between items-center sm:mb-8 mb-4">
                        ...
                        {filteredProducts.length === 0 && products.length > 0 && hasActiveFilters ? (
                            <div className="text-center sm:py-16 py-6 bg-white rounded-xl shadow-sm border border-gray-100">
                                ...
                                <button
                                    onClick={resetFilters}
                                    className="px-6 py-2 bg-[#6a4aca] text-white rounded-lg hover:bg-black transition"
                                >
                                    Reset Filters
                                </button>
                            </div>
                        ) : filteredProducts.length === 0 && products.length > 0 && newArrivalProducts.length === 0 ? (
                            <div className="text-center sm:py-16 py-6 bg-white rounded-xl shadow-sm border border-gray-100">
                                <h3 className="text-xl font-medium text-gray-700">No new arrivals at the moment</h3>
                            </div>
