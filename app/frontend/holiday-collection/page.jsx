...
export default function HolidayCollection() {
    ...
    useEffect(() => {
        const newArrivals = products.filter(product =>
            product.section.includes('holidaycollection')
        );
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            <div className="w-full">
                <img
                    src="/banner/Holidaycollection.png"
                    alt="New Arrivals"
            ...
            <div className='text-center sm:mt-6 mt-5'>
                <h1 className="text-2xl md:text-4xl font-bold sm:mb-4 mb-2">Holiday Collection</h1>
            </div>
                                ...
                                {filteredProducts.map(product => {
                                    ...
                                    return (
                                        <div key={product._id} className="group relative">
                                            <div className="bg-white sm:rounded-md rounded-md overflow-hidden shadow-sm hover:shadow-md border border-[#7a1113] transition duration-300 h-full flex flex-col ">
