        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <header className="mb-12 text-center">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Our commitment is to deliver your Devagroupon bags with care, efficiency, and reliability. Please review the details below to understand how we handle shipping and delivery.
            </p>
          </header>
